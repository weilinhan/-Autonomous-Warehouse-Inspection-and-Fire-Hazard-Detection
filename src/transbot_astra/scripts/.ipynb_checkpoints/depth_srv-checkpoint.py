...
from transbot_msgs.msg import JoyState, Position
from dynamic_reconfigure.server import Server
from transbot_astra.cfg import AstraFollowPIDConfig
...
class depth_src:
    def __init__(self):
        ...
        self.sub_depth = rospy.Subscriber("/camera/depth/image_raw", Image, self.depth_img_Callback)
        ...
        Server(AstraFollowPIDConfig, self.AstraFollowPID_callback)
...
if __name__ == '__main__':
    rospy.init_node("depth_src", anonymous=False)
    depth_src()
    rospy.spin()
